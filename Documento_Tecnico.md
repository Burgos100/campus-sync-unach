# Documento Técnico: Sistema Automatizado DevOps
**Proyecto:** Plataforma Cloud para Gestión de Actividades Universitarias con Asistencia de IA (CampusSync UnACh)
...
El despliegue se realiza sobre una máquina virtual **Amazon EC2** (Ubuntu Server 20.04/22.04).
...
## 8. Evidencias
*(Recomendación: Pega aquí tus capturas de pantalla)*
* Captura 1: Repositorio en GitHub mostrando el `README.md` actualizado y el historial de commits.
* Captura 2: El Pipeline de GitHub Actions marcado en verde (exitoso) mostrando los test de Jest pasados.
* Captura 3: Interfaz visual mostrando la Plataforma funcionando en el navegador (preferiblemente apuntando a la IP pública de AWS).
* Captura 4: Consola de AWS EC2 mostrando la instancia corriendo.
* Captura 5: Interfaz mostrando el resultado de la IA Generativa (Reporte o Actividad).
...
4. **Almacenamiento (StatefulSets):** Separar la base de datos hacia un servicio gestionado como Amazon RDS, o manejarla dentro del clúster con volúmenes persistentes y StatefulSets.
